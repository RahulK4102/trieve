    ...
    <div class="rounded border border-neutral-300 bg-white p-4 shadow">
      ...
      <Show when={isPublic()}>
        ...
        <div class="space-x-1.5">
          <button
            class="inline-flex text-sm justify-center rounded-md bg-magenta-500 px-3 py-2 font-semibold text-white shadow-sm hover:bg-magenta-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-magenta-900"
            onClick={() => {
              publishDataset();
            }}
          >
          ...
          <button
            class="inline-flex border-2 text-sm justify-center rounded-md border-magenta-500 px-3 py-2 font-semibold text-magenta-500 shadow-sm hover:bg-magenta-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-magenta-900"
            onClick={() => {
              unpublishDataset();
            }}
          >
